...
def main():
    ...
    if args.w_bits < 16:
        ...
        if args.load_qmodel_path:  # Load Quantized Rotated Model
            ...
            # reset activation quantization precision before performing GPTQ
            quant_utils.reset_activation_quantization_precision(model, args)
            ...
            # set activation quantization again
            quant_utils.set_activation_quantization_precision(model, args)
    ...
    results = lm_eval.simple_evaluate(
        hflm, tasks=task_names, batch_size=args.lm_eval_batch_size
    )["results"]
